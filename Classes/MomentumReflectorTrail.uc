...
//==============================================================================
class MomentumReflectorTrail extends NewLinkTrail;

defaultproperties
{
	// Taken from UED by billa
    ...
    Begin Object Class=SpriteEmitter Name=SpriteEmitter1
        ...
        ColorScale(1)=(RelativeTime=0.100000,Color=(B=255,G=255))
        ColorScale(2)=(RelativeTime=0.800000,Color=(B=255,G=255))
